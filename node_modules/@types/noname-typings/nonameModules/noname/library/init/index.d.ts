export class LibInit {
     ...
     * @returns
     */
    parsex(item: any, scope?: Function | undefined): import("../element/GameEvent/compilers/IContentCompiler.js").EventCompiledContent;
    eval(func: any): any;
     ...
     * @returns {URL}
     */
    parseResourceAddress(link: string | URL, defaultHandle?: ((item: string) => string) | null | undefined, loadAsDataUrlCallback?: ((item: URL) => unknown) | null | undefined, dbNow?: boolean | undefined): URL;
}
