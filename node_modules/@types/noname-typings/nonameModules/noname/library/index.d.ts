export class Library {
    ...
    emotionList: {
        ...
        biexiao_emotion: number;
        chaijun_emotion: number;
        huangdou_emotion: number;
        maoshu_emotion: number;
    };
    animate: {
        skill: {};
        card: {};
    ...
    hooks: Readonly<{
        ...
        checkDie: import("./assembly/index.js").NonameAssembly<NonameAssemblyType, "checkDie">;
        checkUpdate: import("./assembly/index.js").NonameAssembly<NonameAssemblyType, "checkUpdate">;
        checkSkillAnimate: import("./assembly/index.js").NonameAssembly<NonameAssemblyType, "checkSkillAnimate">;
     ...
     * @param {Function} fn
     */
    genAsync(fn: Function): (...args: any[]) => Promise<Generator<unknown, any, any>>;
    ...
    translate: {
        ...
        biexiao_emotion: string;
        chaijun_emotion: string;
        huangdou_emotion: string;
        maoshu_emotion: string;
        pause: string;
        config: string;
        auto: string;
        unknown: string;
    ...
    element: {
        content: {
            ...
            cardsGotoPile: () => void;
            chooseToEnable: (event: globalThis.GameEventPromise, trigger: globalThis.GameEventPromise, player: globalThis.Player) => Promise<void>;
            chooseToDisable: (event: globalThis.GameEventPromise, trigger: globalThis.GameEventPromise, player: globalThis.Player) => Promise<void>;
            swapEquip: () => void;
            disableJudge: () => void;
            enableJudge: () => void;
            phasing: () => void;
    ...
    filter: {
        ...
        characterDisabled: (i: any, libCharacter: any, ...args: any[]) => true | undefined;
         ...
         * @returns { boolean }
         */
        cardDiscardable: (card: Card, player: Player, event?: string | undefined) => boolean;
        /**
         ...
         * @returns { boolean }
         */
        canBeDiscarded: (card: Card, player: Player, target: Player, event?: string | undefined) => boolean;
        /**
         ...
         * @returns { boolean }
         */
        canBeGained: (card: Card, player: Player, target: Player, event?: string | undefined) => boolean;
        cardAiIncluded: (card: any) => boolean;
        filterCard: (card: any, player: any, event: any) => boolean;
        targetEnabledx: (card: any, player: any, target: any, ...args: any[]) => boolean | void;
