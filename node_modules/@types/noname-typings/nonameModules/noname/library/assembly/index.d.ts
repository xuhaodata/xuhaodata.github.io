...
export namespace defaultHookcompatition {
    ...
    let checkDie: NonameAssembly<NonameAssemblyType, "checkDie">;
    let checkUpdate: NonameAssembly<NonameAssemblyType, "checkUpdate">;
    let checkSkillAnimate: NonameAssembly<NonameAssemblyType, "checkSkillAnimate">;
