export class Player extends HTMLDivElement {
     ...
     * @author Curpond
     */
    removeTip(index?: string | undefined): void;
    /**
     * 怒气
     * @param { number } amount
     * @param { boolean } [limit]
     ...
     * 让一名角色明置一些手牌
     */
    addShownCards(...args: any[]): import("./gameEvent.js").GameEvent | undefined;
    /**
     * 让一名角色暗置一些手牌
     */
    hideShownCards(...args: any[]): import("./gameEvent.js").GameEvent | undefined;
    /**
     * 获取角色所有的明置手牌
     */
    getShownCards(): any[];
     ...
     */
    getKnownCards(other?: Player | undefined, filter?: ((card: Card) => boolean) | undefined): any[];
    /**
     * 判断此角色的手牌是否已经被看光了
     * @param { Player } [other]
     */
     ...
     */
    recast(cards: Card | Card[], recastingLose?: ((player: Player, cards: Card[]) => any) | undefined, recastingGain?: ((player: Player, cards: Card[]) => any) | undefined, ...args: any[]): import("./gameEvent.js").GameEvent;
    /**
     ...
     * @param { false } [log]
     */
    showCharacter(num: 0 | 1 | 2, log?: false | undefined, ...args: any[]): import("./gameEvent.js").GameEvent | undefined;
    /**
     * @param { 0 | 1 | 2 } num
     * @param { false } [log]
     */
     ...
     * @returns { GameEventPromise }
     */
    changeGroup(group: string, log?: boolean | undefined, broadcast?: "nobroadcast" | undefined, ...args: any[]): GameEventPromise;
    /**
     * @param { Player } target
     */
     ...
     * @param { boolean } [log]
     */
    clearMark(i: string, log?: boolean | undefined): void;
    /**
     * 移除玩家的标记
     * @param { string } i
     * @param { number } [num = 1]
     * @param { boolean } [log]
     */
    removeMark(i: string, num?: number | undefined, log?: boolean | undefined): void;
    /**
     * 增加玩家的标记
     * @param { string } i
     * @param { number } [num = 1]
     * @param { boolean } [log]
     */
    addMark(i: string, num?: number | undefined, log?: boolean | undefined): void;
    /**
     * 设置玩家的标记数
     * @param { string } name
     * @param { number } num
     * @param { boolean } [log]
     */
    setMark(name: string, num: number, log?: boolean | undefined): void;
    /**
     * 返回玩家的标记数
     * @param { string } i
     * @returns { number }
     ...
     */
    addCharge(num?: number | undefined, log?: boolean | undefined): void;
    /**
     * 移去蓄力点
     * @param { number } [num = 1] 移去蓄力点数
     * @param { boolean } [log] false: 不进行广播
     */
    removeCharge(num?: number | undefined, log?: boolean | undefined): void;
    /**
     * 返回玩家的蓄力点数
     * @param { boolean } [max] true: 返回当前蓄力点与上限之差
     * @returns { number }
     */
    countCharge(max?: boolean | undefined): number;
    /**
     * 获取蓄力点上限
     */
    getMaxCharge(): number;
     ...
     */
    getCacheKey(similar?: boolean | undefined): string;
    /**
     * 返回玩家本回合使用某个技能的次数
     * @param { string } skill
     * @returns { number }
     ...
     */
    iterableGetVCards(arg1?: string | undefined, arg2?: string | Record<string, any> | ((card: Card) => boolean) | undefined): Iterable<Card>;
    /**
     * @param { string } [arg1='h']
     * @param { string | Record<string, any> | ((card: Card) => boolean) } [arg2]
     * @returns { Card[] }
     */
    getVCards(arg1?: string | undefined, arg2?: string | Record<string, any> | ((card: Card) => boolean) | undefined): Card[];
    /**
     * @param { Parameters<typeof this['iterableGetCards']>[0] } [arg1]
     * @param { Parameters<typeof this['iterableGetCards']>[1] } [arg2]
     */
    countVCards(arg1?: Parameters<this["iterableGetCards"]>[0] | undefined, arg2?: Parameters<this["iterableGetCards"]>[1] | undefined): number;
    /**
     * @param { string } [arg1='h']
     * @param { string | Record<string, any> | ((card: Card) => boolean) } [arg2]
     * @returns { Iterable<Card> }
     ...
     */
    iterableGetDiscardableCards(player: Player, arg1?: string | undefined, arg2?: string | undefined): Generator<Card, void, unknown>;
     ...
     */
    iterableGetGainableCards(player: Parameters<(card: import("../index.js").Card, player: import("../index.js").Player, target: import("../index.js").Player, event?: string | undefined) => boolean>[1], arg1: Parameters<this["iterableGetCards"]>[0], arg2: Parameters<this["iterableGetCards"]>[1]): Generator<any, void, unknown>;
    /**
     *
     ...
     */
    getGainableCards(player: Parameters<this["iterableGetGainableCards"]>[0], arg1?: Parameters<this["iterableGetGainableCards"]>[1] | undefined, arg2?: Parameters<this["iterableGetGainableCards"]>[2] | undefined): any[];
     ...
     */
    gainMultiple(targets: Player[], position?: string | undefined): import("./gameEvent.js").GameEvent;
    /**
     * 令玩家获得一些牌
     * @returns { GameEventPromise }
     */
     ...
     */
    give(cards: Card | Card[], target: Player, visible?: boolean | undefined): any;
     ...
     * @param { number } [num]
     */
    loseHp(num?: number | undefined): import("./gameEvent.js").GameEvent;
    /**
     * 扣减玩家的体力上限
     * @returns { GameEventPromise }}
     */
     ...
     * @returns { GameEventPromise }
     */
    changeHp(num: number, popup?: boolean | undefined): GameEventPromise;
    /**
     * 调整玩家的护甲值
     * @param { number } [num]
     ...
     * @returns { GameEventPromise }
     */
    changeHujia(num?: number | undefined, type?: "gain" | "lose" | "damage" | "null" | undefined, limit?: number | undefined): GameEventPromise;
     ...
     * @param { boolean } [log]
     */
    revive(hp?: number | undefined, log?: boolean | undefined): void;
    isMad(): boolean;
    /**
     * 令玩家进入混乱状态
     */
     ...
     * @returns { GameEventPromise }
     */
    addJudge(card: Card, cards?: any[] | undefined): GameEventPromise;
    /**
     * 返回某些牌是否能进入玩家的判定区
     * @overload
    ...
    addJudgeNext(card: any, unlimited: any): any;
     ...
     * @param { boolean } [logv]
     */
    logSkill(name: string | string[], targets?: Player | Player[] | undefined, nature?: string | boolean | undefined, logv?: boolean | undefined, args: any): void;
    unprompt(): void;
     ...
     * @returns
     */
    canUse(card: Card | VCard | object | string, target: Player, distance?: false | undefined, includecard?: boolean | GameEvent): boolean | void;
    /**
     * 场上是否存在能对其使用card的目标
     * @param { Card | VCard | object | string } card
     * @param { false } [distance] false：无距离限制
     ...
     * @returns { boolean }
     */
    hasUseTarget(card: Card | VCard | object | string, distance?: false | undefined, includecard?: boolean | GameEvent): boolean;
    /**
     * 场上是否存在收益为正的目标
     * @param { Card | VCard | object | string } card
     * @param { false } [distance] false：无距离限制
     ...
     * @returns { boolean }
     */
    hasValueTarget(card: Card | VCard | object | string, distance?: false | undefined, includecard?: boolean | GameEvent): boolean;
    /**
     * card使用价值
     * @param { Card | VCard | object | string } card
     * @param { false } [distance] false：无距离限制
     ...
     */
    getUseValue(card: Card | VCard | object | string, distance?: false | undefined, includecard?: boolean | GameEvent): number;
    /**
     * 添加随从
    ...
    callSubPlayer(...args: any[]): import("./gameEvent.js").GameEvent | undefined;
    toggleSubPlayer(...args: any[]): import("./gameEvent.js").GameEvent | undefined;
    ...
    addSkillLog(skill: any, popup?: boolean): this | undefined;
    removeSkillLog(skill: any, popup?: boolean): this | undefined;
    addInvisibleSkill(skill: any): void;
    removeInvisibleSkill(skill: any, ...args: any[]): any;
    addSkills(skill: any): import("./gameEvent.js").GameEvent | undefined;
    removeSkills(skill: any): import("./gameEvent.js").GameEvent | undefined;
    changeSkills(addSkill?: any[], removeSkill?: any[], popup?: boolean): import("./gameEvent.js").GameEvent | undefined;
    ...
    removeEquipTrigger(card: any, hasMove: any): this | undefined;
     ...
     * @returns
     */
    addTempSkills(skillsToAdd: SAAType<string>, expire?: SkillTrigger | SAAType<Signal> | undefined): import("./gameEvent.js").GameEvent;
    /**
     * 添加临时技能
     * @overload
     ...
     */
    addTempSkill(skill: string | string[], expire?: SkillTrigger | SAAType<Signal> | undefined, checkConflict?: boolean | undefined): any;
     ...
     */
    getRoundHistory<T extends Exclude<keyof ActionHistory, "isRound" | "isMe">>(key: T, filter: ((event: GameEventPromise) => boolean) | undefined, num?: number | undefined, keep?: boolean | undefined, last: GameEventPromise): any[];
    /**
     ...
     */
    getHistory<T extends Exclude<keyof ActionHistory, "isRound" | "isMe">>(key: T, filter?: ((event: GameEventPromise) => boolean) | undefined, last?: GameEventPromise): ActionHistory[T];
    /**
     * 遍历历史
     * @template { Exclude<keyof ActionHistory,'isRound'|'isMe'> } T
     * @param { T } key
     ...
     * @returns { boolean }
     */
    hasHistory<T extends Exclude<keyof ActionHistory, "isRound" | "isMe">>(key: T, filter?: ((event: GameEventPromise) => boolean) | undefined, last?: GameEventPromise): boolean;
    /**
     * 不填参数，直接获得最后一个回合的改玩家的整个历史对象。
     * @overload
     * @returns { ActionHistory }
     ...
     * @returns { ActionHistory[T] }
     */
    getLastHistory<T extends Exclude<keyof ActionHistory, "isRound" | "isMe">>(key: T, filter?: ((event: GameEventPromise) => boolean) | undefined, last?: GameEventPromise): ActionHistory[T];
    /**
     * 遍历整局游戏该玩家的历史
     * @template { Exclude<keyof ActionHistory,'isRound'|'isMe'> } T
     * @param { T } key
     ...
     * @returns { ActionHistory[T] }
     */
    getAllHistory<T extends Exclude<keyof ActionHistory, "isRound" | "isMe">>(key: T, filter?: ((event: GameEventPromise) => boolean) | undefined, last?: GameEventPromise): ActionHistory[T];
    /**
     * @template { Exclude<keyof ActionHistory,'isRound'|'isMe'> } T
     * @param { T } key
     * @param { (event: GameEventPromise) => boolean } filter
     ...
     * @returns { boolean }
     */
    isMaxHp(only?: boolean | undefined, raw?: boolean | undefined): boolean;
    /**
     * 判断玩家是否是场上体力最少的玩家
     * @param { boolean } [only] 是否唯一
     * @param { boolean } [raw]
     * @returns { boolean }
     */
    isMinHp(only?: boolean | undefined, raw?: boolean | undefined): boolean;
    /**
     * 判断玩家是否是场上牌最多的玩家
     * @param { boolean } [only] 是否唯一
     * @returns { boolean }
     */
    isMaxCard(only?: boolean | undefined): boolean;
    /**
     * 判断玩家是否是场上牌最少的玩家
     * @param { boolean } [only] 是否唯一
     * @returns { boolean }
     */
    isMinCard(only?: boolean | undefined): boolean;
    /**
     * 判断玩家是否是场上手牌最多的玩家
     * @param { boolean } [only] 是否唯一
     * @returns { boolean }
     */
    isMaxHandcard(only?: boolean | undefined): boolean;
    /**
     * 判断玩家是否是场上手牌最少的玩家
     * @param { boolean } [only] 是否唯一
     * @returns { boolean }
     */
    isMinHandcard(only?: boolean | undefined): boolean;
    /**
     * 判断玩家是否是场上装备区牌最多的玩家
     * @param { boolean } [only] 是否唯一
     * @returns { boolean }
     */
    isMaxEquip(only?: boolean | undefined): boolean;
    /**
     * 判断玩家是否是场上装备区牌最少的玩家
     * @param { boolean } [only] 是否唯一
     * @returns { boolean }
     */
    isMinEquip(only?: boolean | undefined): boolean;
    /**
     * 返回玩家是否是横置状态
     * @returns { boolean }
     */
     ...
     */
    needsToDiscard(add?: number | Card[] | Card, filter?: ((card?: Card, player?: Player) => boolean) | undefined, pure?: boolean | undefined): number;
     ...
     * @returns { boolean }
     */
    hasSkill(skill: string, arg2?: Parameters<this["getSkills"]>[0] | undefined, arg3?: Parameters<this["getSkills"]>[1] | undefined, arg4?: Parameters<this["getSkills"]>[2] | undefined): boolean;
    /**
     * @param { string } skill
     ...
     */
    hasSkillTag(tag: string, hidden?: Parameters<this["getSkills"]>[0] | undefined, arg?: Parameters<SkillAI["skillTagFilter"]>[2], globalskill?: boolean | undefined): boolean;
    /**
     *
     * @overload
     * @param { string } name
     ...
     * @returns { boolean }
     */
    hasUnknown(num?: number | undefined): boolean;
     ...
     */
    hasSha(respond?: string | boolean | undefined, noauto?: boolean | undefined): boolean | undefined;
    /**
     * 有没有可用闪
     * @param { string | boolean } [respond] 响应什么类型，默认全部。"use": 使用，true / "respond": 打出
     */
    hasShan(respond?: string | boolean | undefined): boolean | undefined;
    /**
     ...
     */
    mayHaveSha(viewer?: Player | undefined, type?: "respond" | "use" | undefined, ignore?: Card[] | Card | null, rvt?: "bool" | "count" | "odds" | undefined): boolean | number;
    /**
     ...
     */
    mayHaveShan(viewer?: Player | undefined, type?: "respond" | "use" | undefined, ignore?: Card[] | Card | null, rvt?: "bool" | "count" | "odds" | undefined): boolean | number;
    hasCard(name: any, position: any): boolean;
    hasVCard(name: any, position: any): boolean;
    getVEquip(name: any): any;
     ...
     * @returns { VCard|null }
     */
    getVJudge(name?: string | undefined): VCard | null;
    /**
     * 返回玩家判定区中的牌
     * @deprecated
     * @param { string } [name]
     * @returns { Card|null }
     */
    getJudge(name?: string | undefined): Card | null;
     ...
     */
    $fullscreenpop(str: any, nature?: any, avatar?: any, broadcast?: false | undefined): void;
    /**
     *
