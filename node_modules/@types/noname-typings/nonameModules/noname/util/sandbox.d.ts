...
export class Monitor {
     ...
     * @param {Monitor} thiz
     */
    static "__#10@#exposeInfo": (thiz: Monitor) => (Set<any> | null)[];
    /**
     * ```plain
     ...
     * @param  {...any} args
     */
    static [SandboxExposer2](signal: Symbol, ...args: any[]): void | Set<Monitor> | (Set<any> | null)[];
    /**
     * ```plain
     * 获取 Monitor 所属的运行域
     * ```
...
export class Marshal {
     ...
     * @param {Function} func
     */
    static decompileFunction(func: Function): string;
    /**
     * ```plain
     ...
     */
    static canCreateFunction(paramList: string | string[], funcBody: string, type?: ("async" | "generator" | "agenerator" | "any" | null) | undefined): any;
    /**
     * ```plain
     * 陷入某个运行域并执行代码
     * ```
...
export class Sandbox {
     ...
     * @returns
     */
    static [SandboxExposer2](signal: Symbol, ...args: any[]): string | undefined;
    /**
     * ```plain
     * 获取当前的scope
     * ```
