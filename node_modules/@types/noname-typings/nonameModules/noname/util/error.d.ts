export class CodeSnippet {
    ...
    static "__#3@#snippetStack": Array<CodeSnippet>;
    /**
     * ```plain
     * 获取当前代码片段
     * ```
     ...
     * @type {CodeSnippet?}
     */
    static get currentSnippet(): CodeSnippet | null;
    /**
     * ```plain
     * 压入一个代码片段作为当前代码片段
     * ```
...
export class ErrorReporter {
    static "__#4@#topAlert": ((message?: any) => void) & typeof alert;
    static "__#4@#errorLineNoPatterns": RegExp[];
    static "__#4@#findLineNo": (line: any) => number;
    /**
     * ```plain
     * 向用户报告错误信息
     * ```
...
export class ErrorManager {
    ...
    static "__#5@#codeSnippets": WeakMap<Function, CodeSnippet>;
    /** @type {WeakMap<Object, ErrorReporter>} */
    static "__#5@#errorReporters": WeakMap<any, ErrorReporter>;
    /**
     * ```plain
     * 获取函数对应的代码片段
     * ```
     ...
     * @returns {string[]?}
     */
    static "__#5@#getFramesHead": (error: Error) => string[] | null;
    /**
     * ```plain
     * 计算错误A比错误B多的堆栈层数
     * ```
     ...
     * @returns {number?}
     */
    static "__#5@#compareStackLevel": (errorA: Error, errorB: Error) => number | null;
    /**
     * ```plain
     * 封装被设定了代码片段函数的错误捕获调用
     *
