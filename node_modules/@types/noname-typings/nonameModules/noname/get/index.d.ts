export class Get extends GetCompatible {
     ...
     */
    cardsetion(player: Player, sourceEvent: GameEventPromise): GameEvent | string;
    /**
     * 返回牌名“【XXX】”形式的数组
     * @param { Function } [filter]
     * @returns { string[] }
     */
    cardTranslation(filter?: Function | undefined): string[];
    /**
     * 获取装备牌对应的技能
     ...
     * @returns {string[][]}
     */
    inpileVCardList(filter?: Function | undefined): string[][];
    /**
     ...
     * @returns { String[] }
     */
    zhinangs(filter?: boolean | Function | undefined): string[];
    /**
     * 用于获取武将的姓氏和名字
     ...
     */
    bottomCards(num?: number | undefined, putBack?: boolean | undefined): Card[] | Card;
    /**
     * 返回本回合在进入弃牌堆且还在弃牌堆的牌
     * @returns { Card[] }
     */
     ...
     * @returns { number }
     */
    rand(num: number, num2?: number | undefined): number;
     ...
     */
    stringify(obj: any, level?: number | undefined): any;
    /**
     * 深拷贝函数（虽然只处理了部分情况）
     *
     ...
     */
    copy<T>(obj: T, copyKeyDeep?: boolean | undefined, map?: WeakMap<any, unknown> | undefined): T;
     ...
     * @returns {boolean}
     */
    isFunctionBody(code: string, type?: "async" | "generator" | "agenerator" | "any" | null): boolean;
    /**
     * ```plain
     * 清洗函数体代码
     * ```
     ...
     * @returns { string }
     */
    type(obj: Card | string, method?: "trick" | null | undefined, player?: Player | false): string;
     ...
     * @returns { Card[] | Card } num为0返回Card，否则返回Cards
     */
    cards(num?: number | undefined, putBack?: boolean | undefined): Card[] | Card;
    judge(card: any): any;
    judge2(card: any): any;
     ...
     * @returns {GameEvent[T]}
     */
    event<T extends keyof GameEvent>(key: T): GameEvent[T];
    player(): any;
    /**
     * 返回玩家的数组
     * @param {*} [sort]
     ...
     * @returns { Player[] }
     */
    players(sort?: any, dead?: boolean | undefined, out?: boolean | undefined): Player[];
    /**
    ...
    skillInfoTranslation(name: any, player: any): string;
    /**
     * @returns {string}
     */
     ...
     * @returns { string }
     */
    strNumber(num: number, forced?: boolean | undefined): string;
    /**
     * 返回扑克牌中的表示形式对应的数字
     * @param { string } str
     ...
     * @returns { number }
     */
    numString(str: string, forced?: boolean | undefined): number;
    /**
     * 将阿拉伯数字转换为中文的表达形式
     * @param { number } num
     ...
     * @returns { string }
     */
    cnNumber(num: number, ordinal?: boolean | undefined): string;
    /**
     * 遍历子元素
     ...
     */
    owner(card: Card, method?: "judge" | undefined): Player | undefined;
    noSelected(): boolean;
     ...
     */
    cardPile(name: Function | string | object | true, position?: string | boolean | undefined, start?: string | undefined): Card | ChildNode | null;
    /**
     * 从牌堆获得一张牌
     * @param { function | string | object | true } name 牌的筛选条件或名字，true为任意一张牌
     * @param { string } [start] 遍历方式。默认top
     ...
     * @returns { Card | ChildNode | null }
     */
    cardPile2(name: Function | string | object | true, start?: string | undefined): Card | ChildNode | null;
    /**
     * 从弃牌堆获得一张牌
     * @param { function | string | object | true } name 牌的筛选条件或名字，true为任意一张牌
     * @param { string } [start] 遍历方式。默认top
     ...
     * @returns { Card | ChildNode | null }
     */
    discardPile(name: Function | string | object | true, start?: string | undefined): Card | ChildNode | null;
     ...
     */
    relativePath(url: URL, addAssetURL?: boolean | undefined): string;
    /**
