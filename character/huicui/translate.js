const translates = {
	...
	dcjiaowei: "焦尾",
	dcjiaowei_tag: "弦",
	dcjiaowei_info: "锁定技。①游戏开始时，你将所有手牌标记为“弦”。②你的“弦”牌不计入手牌上限。③当你失去“弦”后，防止你本回合下次受到的伤害。",
	dcfeibai: "飞白",
	...
	dcxidi: "羲笛",
	dcxidi_tag: "笛",
	dcxidi_info: "锁定技。①游戏开始时，你将所有手牌标记为“笛”。②你的“笛”牌不计入手牌上限。③准备阶段，你观看牌堆顶X张牌，然后将这些牌以任意顺序置于牌堆顶和牌堆底（X为你手牌中的“笛”数且至少为1）。",
	dcchengyan: "乘烟",
	dcchengyan_info: "当你于出牌阶段使用【杀】或普通锦囊牌指定其他角色为目标后，你可以摸一张牌并展示之，若展示牌为【杀】或可指定目标的普通锦囊牌，你将使用牌对其的结算方式改为展示牌牌名的结算方式；否则，你将展示牌标记为“笛”。",
	...
	dctanban: "檀板",
	dctanban_info: "①游戏开始时，你将所有手牌标记为“檀板”。②你的“檀板”牌不计入手牌上限。③摸牌阶段结束时，你可以交换两种牌的“檀板”标记。",
	dcdiou: "低讴",
	...
	dcboxuan: "博玄",
	dcboxuan_info: "你使用手牌结算完毕后，若此牌目标包含其他角色，你可展示牌堆底的3张牌，若其中有牌与你使用的牌：1.牌名字数相同，你摸1张牌；2.花色相同，你可弃置一名其他角色1张牌；3.类型相同，你可使用1张展示牌。",
	dcboxuan_rewrite: "博玄·改",
	dcboxuan_rewrite_info: "你使用手牌结算完毕后，若此牌目标包含其他角色，你可展示牌堆底的3张牌，若其中有牌与你使用的牌：1.牌名字数相同，你摸1张牌；2.花色相同，你可弃置一名其他角色1张牌；3.类型相同，你可使用1张展示牌。然后你可将使用的手牌置于牌堆底",
	dcyizheng: "议政",
	dcyizheng_info: "你的回合开始和结束时，你可与任意名其他角色各展示1张手牌，若展示的牌类型均相同，你可将这些牌交给一名角色，否则，你弃置这些牌并失去1点体力。",
	dcguilin: "归林",
