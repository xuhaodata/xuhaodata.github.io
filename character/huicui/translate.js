const translates = {
	...
	dcmiyun: "密运",
	dcmiyun_tag: "安",
	dcmiyun_info: "锁定技。①每轮开始时，你依次执行：1.若你有“安”，你将包括“安”的在内的任意张手牌交给一名其他角色，然后你将手牌补至体力上限；2.你正面向上获得一名其他角色的一张牌，称为“安”。②当你不因〖密运①〗失去“安”后，你失去1点体力。",
	dcdanying: "胆迎",
	...
	dczecai: "择才",
	dczecai_info: "限定技。每轮开始时，若游戏轮数大于1，则你可令一名其他角色获得〖集智〗直到下一轮游戏开始；若其是上一轮内使用过锦囊牌数量唯一最多的角色，则其获得一个额外的回合。",
	dcyinshi: "隐世",
	...
	dclingkong: "灵箜",
	dclingkong_tag: "箜篌",
	dclingkong_info: "锁定技。①游戏开始时，你将初始手牌标记为“箜篌”。②你的“箜篌”牌不计入手牌上限。③当你于一回合内首次于摸牌阶段外得到牌后，你将这些牌标记为“箜篌”。",
	dcxianshu: "贤淑",
	...
	dcjiaowei: "焦尾",
	dcjiaowei_tag: "弦",
	dcjiaowei_info: "锁定技。①游戏开始时，你将初始手牌标记为“弦”。②你的“弦”牌不计入手牌上限。③当你失去“弦”后，防止你本回合下次受到的伤害。",
	dcfeibai: "飞白",
	dcfeibai_info: "当你使用牌结算完毕后，你可以从牌堆中随机获得一张字数为X的牌（X为此牌与你本回合使用的上一张牌的字数之和）。若你未因此获得牌，则你摸一张牌并标记为“弦”，然后〖飞白〗于本回合失效。",
	kuaiqi: "蒯祺",
	dcliangxiu: "良秀",
	...
	dcqiqin: "绮琴",
	dcqiqin_tag: "琴",
	dcqiqin_info: "锁定技。①游戏开始时，你将初始手牌标记为“琴”。②你的“琴”牌不计入手牌上限。③准备阶段，你获得位于弃牌堆的所有“琴”。",
	dcweiwan: "媦婉",
	...
	yue_miheng_prefix: "乐",
	dcjigu: "激鼓",
	dcjigu_info: "锁定技。①游戏开始时，你将初始手牌标记为“激鼓”。②你的“激鼓”牌不计入手牌上限。③当你造成或受到伤害后，若你的“激鼓”牌数等于你的装备区牌数，你可以摸X张牌（X为你的空缺装备栏数）。然后若你本轮〖激鼓〗发动次数不小于已进行过回合的角色数，此效果本轮失效。",
	dcsirui: "思锐",
	...
	dcyunzheng: "韵筝",
	dcyunzheng_tag: "筝",
	dcyunzheng_info: "锁定技。①游戏开始时，你将初始手牌标记为“筝”。②你的“筝”牌不计入手牌上限。③手牌中有“筝”的其他角色的非锁定技失效。",
	dchuoxin: "惑心",
	...
	dcxidi: "羲笛",
	dcxidi_tag: "笛",
	dcxidi_info: "锁定技。①游戏开始时，你将初始手牌标记为“笛”。②你的“笛”牌不计入手牌上限。③准备阶段或结束阶段，你观看牌堆顶X张牌，然后将这些牌以任意顺序置于牌堆顶和牌堆底（X为你手牌中的“笛”数且至少为1）。",
	dcchengyan: "乘烟",
	...
	dctanban: "檀板",
	dctanban_info: "①游戏开始时，你将初始手牌标记为“檀板”。②你的“檀板”牌不计入手牌上限。③摸牌阶段结束时，你可以交换两种牌的“檀板”标记。",
	dcdiou: "低讴",
	...
	panghong: "庞宏",
	dcpingzhi: "评骘",
	dcpingzhi_info: "转换技。出牌阶段限一次，你可观看一名角色的手牌并展示其中一张牌，阳：你弃置此牌，然后其视为对你使用一张【火攻】，若此【火攻】未造成伤害则此技能视为未发动过；阴：然后其使用此牌，若此牌造成伤害则此技能视为未发动过。",
	dcgangjian: "刚简",
	...
	dcboxuan: "博玄",
	dcboxuan_info: "你使用手牌结算完毕后，若此牌目标包含其他角色，你可展示牌堆底的三张牌，若其中有牌与你使用的牌：1.牌名字数相同，你摸一张牌；2.花色相同，你可弃置一名其他角色一张牌；3.类型相同，你可使用1张展示牌。",
	dcboxuan_rewrite: "博玄·改",
	dcboxuan_rewrite_info: "你使用手牌结算完毕后，若此牌目标包含其他角色，你可展示牌堆底的三张牌，若其中有牌与你使用的牌：1.牌名字数相同，你摸一张牌；2.花色相同，你可弃置一名其他角色一张牌；3.类型相同，你可使用1张展示牌。然后你可将使用的手牌置于牌堆底",
	dcyizheng: "议政",
	dcyizheng_info: "你的回合开始和结束时，你可与任意名其他角色各展示一张手牌，若展示的牌类型均相同，你可将这些牌交给一名角色，否则，你弃置这些牌并失去1点体力。",
	dcguilin: "归林",
	dcguilin_info: "限定技，你进入濒死状态时，可弃置任意张牌并回复等量体力值，然后失去〖议政〗并修改〖博玄〗。",
};
