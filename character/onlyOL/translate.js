const translates = {
	...
	olsbjueya: "绝崖",
	olsbjueya_info: "当你需要使用一张基本牌时（不能为你因此使用过的），若你没有手牌，你可以视为使用此牌。",
	...
	olchaozheng: "朝争",
	olchaozheng_info: "①准备阶段，你可以令与所有其他角色议事。若结果为：红色，意见为红色的角色各回复1点体力；黑色，意见为红色的其他角色各失去1点体力。然后你摸X张牌（X为此次议事意见与你相同的角色数且至多为3）。②当你参与的议事展示意见时，你的意见权重+1。",
	olshenchong: "甚宠",
