const translates = {
	...
	dm_simayi_prefix: "魔",
	olguifu: "诡伏",
	olguifu_info: "每轮开始时或你的体力值变化后，你可以随机从牌堆或弃牌堆获得一张不计入手牌上限的【闪】；本局游戏中牌或技能直接造成伤害后，你记录此牌名或技能。每回合每种牌名限一次，你可以将因此技能获得的【闪】当做记录的牌名使用且不计入次数限制。",
	olmoubian: "谋变",
	...
	olrumo: "入魔",
	olrumo_info: "锁定技，每轮结束时，若你本轮未造成过伤害，你失去一点体力。（入魔轮次除外)",
};
