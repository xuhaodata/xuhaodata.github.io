const translates = {
	...
	olliance: "敛策",
	olliance_info: "每轮你的回合内和回合外各限一次，当你的手牌数变化后，若为全场最少，你可将手牌摸至体力上限，然后本回合下一次有角色造成伤害时，此伤害+1",
	...
	olguanbian: "观变",
	olguanbian_info: "锁定技。①游戏开始时，你的手牌上限、其他角色计算与你的距离、你计算与其他角色的距离+X（X为游戏人数）。②第二轮游戏开始时，或当你发动〖凶逆〗或〖封赏〗后，你失去〖观变〗。",
	olxiongni: "凶逆",
	...
	dm_simayi_prefix: "魔",
	olguifu: "诡伏",
	olguifu_info: "每轮开始时或你受到伤害、失去体力、回复体力后，你可以随机从牌堆或弃牌堆获得一张不计入手牌上限的【闪】；本局游戏中牌或技能直接造成伤害后，你记录此牌名或技能。每回合每种牌名限一次，你可以将因此技能获得的【闪】当做记录的牌名使用且不计入次数限制。",
	olmoubian: "谋变",
	olmoubian_info: "准备阶段，若你记录的牌名和技能之和大于等于3，你可以“入魔”，获得记录的全部技能，然后获得〖骤袭〗。",
	olmoubian_append: `<span style="font-family:yuanli"><li>入魔：每局游戏限一次，当你满足条件后，可入魔。入魔后，每轮结束时，若本轮你未造成过伤害，你失去一点体力。</span>`,
	olzhouxi: "骤袭",
	olzhouxi_info: "准备阶段，你从三个可造成伤害的技能中选择一个获得直到你的下回合开始。本轮受到你伤害的角色于本轮结束时可视为对你使用一张【杀】。",
	olrumo: "入魔",
