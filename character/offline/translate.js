const translates = {
	...
	hm_jijun: "集军",
	hm_jijun_info: "当牌指定你为第一个目标后，若此牌的使用者为你，你可以进行判定，然后选择一项：1.获得此牌；2.将判定牌置于武将牌上，称为“方”。",
	hm_fengtong: "方统",
	hm_fengtong_info: "出牌阶段结束时，若有“方”，你可以重铸一张手牌，若你重铸的牌与任意张“方”的点数之和为36，你可以将对应的“方”置入弃牌堆，然后对一名其他角色造成3点雷电伤害。",
	hm_zhouyuan: "咒怨",
	...
	hm_juedian: "决巅",
	hm_juedian_info: "锁定技，当你每回合首次使用目标唯一的牌造成伤害后，你选择一项并视为对受伤角色使用一张【决斗】：<br>1：失去1点体力；<br>2：减1点体力上限；<br>背水:此决斗1造成的伤害+1。",
	hm_nitian: "逆天",
	hm_nitian_info: "限定技，出牌阶段，令你本回合使用牌不能被抵消；结束阶段，若你本回合未杀死角色，你死亡。",
	hm_xiongshi: "凶势",
	...
	hm_wenchen: "违谶",
	hm_wenchen_info: "限定技，出牌阶段，你可以依次选择两名其他角色，然后你展示前者的手牌，并与后者各摸三张牌。若如此做，前者对后者依次使用手牌中的所有伤害牌，且本回合这两名角色互相使用牌无次数限制。",
	hm_shuiqu: "随去",
	hm_shuiqu_info: "锁定技，每名角色的弃牌阶段，你弃置所有手牌。若你以此法弃置了至少一张牌，你可以选择增加1点体力上限或回复1点体力。",
	hm_yure: "余热",
	...
	hm_yufeng: "御风",
	hm_yufeng_info: "出牌阶段限一次，你可以进行判定，若结果为：♠️，你令一名其他角色跳过其下个回合的出牌阶段和弃牌阶段；♥️，你令一名其他角色跳过其下个回合的摸牌阶段；♣️或♦️，你摸一张牌并重置“御风”。",
	hm_weiluan: "为乱",
	hm_weiluan_info: "锁定技，准备阶段/摸牌阶段/出牌阶段开始时，你进行判定，若结果为♠️，你的攻击范围/摸牌阶段摸牌数/使用杀的限制次数+1。",
	hm_tianpan: "天判",
	hm_tianpan_info: "锁定技，当你的判定牌生效时，若结果为♠️，你获得此牌，然后你回复1点体力或1点体力上限；不为♠️，你失去1点体力或减1体力上限。",
	hm_gaiming: "改命",
	hm_gaiming_info: "每回合限一次，当你的判定牌生效前，若结果不为♠️，你可以亮出牌堆顶的一张牌代替之。",
	hm_tuntian: "屯天",
	hm_tuntian_info: "锁定技，准备阶段，你令你本回合的摸牌阶段摸牌数、手牌上限、本回合首次造成的伤害+1直到你发动〖进军〗。",
	hm_qianjun: "迁军",
