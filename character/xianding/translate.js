const translates = {
	...
	dcsbshimou: "势谋",
	dcsbshimou_info: "转换技，游戏开始可自选阴阳状态，出牌阶段限一次，你可令一名阳：手牌数全场最低的角色阴：手牌数全场最高的角色将手牌调整至体力上限（至多摸5）并视为使用一张仅指定一个目标的普通锦囊牌（此牌牌名与目标由你指定）。若以此法摸牌，该锦囊可额外增加1个目标；若以此法弃牌，该锦囊可额外结算一次。",
};
