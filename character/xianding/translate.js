const translates = {
	...
	dcxiongmu: "雄幕",
	dcxiongmu_tag: "雄幕",
	dcxiongmu_info: "①一轮游戏开始时，你可以将手牌摸至体力上限（若手牌数不小于体力上限则跳过），然后将任意张牌随机置入牌堆，从牌堆或弃牌堆中获得等量的点数为8的牌，且这些牌本轮不计入手牌上限。②当你于一回合首次受到伤害时，若你的手牌数不大于你的体力值，此伤害-1。",
	dczhangcai: "彰才",
	...
	dclianjie: "连捷",
	dclianjie_info: "每回合每个点数限一次，你使用手牌指定目标后，若此牌点数不大于你的所有手牌（无点数视为0），你可令一名角色将其一张点数最小的手牌置于牌堆底，然后你将手牌摸至体力上限，以此法获得的牌本回合无次数限制。",
	dcjiangxian: "将贤",
	dcjiangxian_info: "限定技，出牌阶段，你可以获得以下效果直到本回合结束：当你使用因〖连捷〗获得的牌造成伤害时，此伤害+1。若如此做，本回合结束后你失去〖连捷〗或〖朝镇〗。",
	dc_sb_chenlin: "新杀谋陈琳",
	...
	pangfengyi: "庞凤衣",
	dcyitong: "异瞳",
	dcyitong_info: "锁定技。①游戏开始时，你记录一个花色。②每回合〖异瞳〗记录花色的牌首次进入弃牌堆后，你从牌堆或弃牌堆获得与此花色不同的牌各一张。",
	dcpeiniang: "醅酿",
	...
	wu_lukang_prefix: "武",
	dckegou: "克构",
	dckegou_info: "锁定技，其他角色的回合结束时，你随机获得本回合进入弃牌堆的牌中点数最大的一张牌。",
	dcjiduan: "急断",
	dcjiduan_info: "每回合每名角色限一次，你使用牌指定目标后，你可令其中一个目标展示一张手牌，若此牌点数小于你使用的牌，则你选择一项：1、令其弃置每种花色的手牌各一张；2、令其摸手牌中没有的花色各一张牌。若你使用的牌点数为K，则不计入此技能的限制次数。",
	dcdixian: "砥贤",
	dcdixian_info: "限定技，出牌阶段，你可以弃置任意张手牌，然后从牌堆中按点数从大到小的顺序获得等量的牌，这些牌不计入手牌上限。",
	v_lvbu: "威吕布",
	v_lvbu_prefix: "威",
	dcxiaowu: "骁武",
	...
	dcminshan: "愍善",
	dcminshan_info: "当你受到伤害后，你可令一名角色从牌堆中获得两张与此伤害牌相同花色的牌（若〖育贤〗存在记录花色，则改为获得〖育贤〗记录花色的牌）。",
	zhanghuai: "张怀",
	get dclaoyan() {
	...
	dczhanyu: "占欲",
	dczhanyu_info: "回合开始时，你展示一张手牌，然后所有其他角色依次随机弃置一张与此牌花色相同的手牌。",
	liujinliupei: "刘衿刘佩",
	dcllqixin: "契心",
	...
	dcguangyong_info: "锁定技。①当你使用牌指定自己为目标后，若你的体力上限小于8，则你增加1点体力上限。②当你使用牌指定其他角色为目标后，你选择一名有牌的其他目标角色。若你的体力上限大于1，则你减1点体力上限。然后你获得其一张牌。",
	dcjuchui: "据陲",
	...
	dcsbbizuo: "弼佐",
	dcsbbizuo_info: "限定技，每名角色回合结束时，若一号位体力全场最低，你可令一名角色立即执行一个额外回合，直至该回合结束除你与该角色外，其余角色非锁定技失效，该回合结束后你分配当前回合所有不因弃置而进入弃牌堆的牌。",
	dcsbshimou: "势谋",
	dcsbshimou_info: "转换技，游戏开始可自选阴阳状态，出牌阶段限一次，你可令一名阳：手牌数全场最低的角色；阴：手牌数全场最高的角色将手牌调整至体力上限（至多摸5）并视为使用一张仅指定一个目标的普通锦囊牌（此牌牌名与目标由你指定）。若以此法摸牌，该锦囊可额外增加1个目标；若以此法弃牌，该锦囊可额外结算一次。",
	dcsbxianshi: "先识",
	dcsbxianshi_info: "你成为锦囊牌目标时，你的手牌均可当作【无懈可击】使用直到此牌结算完毕，此牌结算后你获得此牌结算期间所有不因你使用而进入弃牌堆的牌。",
};
