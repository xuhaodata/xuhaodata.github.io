const translates = {
	...
	dcbaguan: "霸关",
	dcbaguan_info: "连招技（指定自己为目标的牌+武器牌），你可将至多X张手牌当作基础伤害为对应实体牌数且不计入次数，无次数限制的【杀】使用（X为你装备区武器牌字数之和）。",
	xuxin: "徐馨",
	dcyuxian: "育贤",
	dcyuxian_info: "当你于出牌阶段使用牌时，你记录此牌花色，直到你的下个出牌阶段清除。（至多记录4个花色）其他角色于其回合内使用与你记录花色顺序相同的牌时，你可与其各摸一张牌。",
	dcminshan: "愍善",
	dcminshan_info: "当你受到伤害后，你可令一名角色从牌堆中获得两张与此伤害牌相同花色的牌。",
	zhanghuai: "张怀",
	get dclaoyan() {
