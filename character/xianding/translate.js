const translates = {
	...
	dcbaguan: "霸关",
	dcbaguan_info: "连招技（单目标牌+武器牌），你可将至多X张手牌当作基础伤害为对应实体牌数且不计入次数，无次数限制的【杀】使用（X为你装备区武器牌字数之和）。",
	xuxin: "徐馨",
	dcyuxian: "育贤",
	...
	dclaoyan_info: "锁定技，一张牌指定你为目标后，若此牌存在其他目标角色，则你令此牌对其他目标角色无效。然后你从牌堆中获得点数小于此牌的牌各一张，且于本回合结束时弃置此牌。",
	dcjueyan: "诀言",
