const translates = {
	...
	shen_xuzhu_prefix: "神",
	zhengqing: "争擎",
	zhengqing_info: "锁定技。每轮开始时，你移去所有角色的“擎”标记，令上一轮于一回合内造成伤害值最高的角色获得此值数量枚“擎”，然后你与其各摸一张牌（多名角色则随机选择，优先为你）。若该角色为你且本次获得的“擎”数为本局游戏最多的一次，你改为摸X张牌（至多摸五张）。",
	zhuangpo: "壮魄",
	...
	dclinjie:"凛界",
	dclinjie_info:"每轮开始时，你可令一名没有「凛」的角色获得一个「凛」标记。有「凛」的其他角色受到伤害后，随机弃置一张手牌。若其因此弃置了最后一张手牌，你对其造成1点伤害并移去「凛」。",
	dcduzhang:"独仗",
	dcduzhang_info:"每回合限两次，当你使用黑色牌指定唯一目标或成为黑色牌的唯一目标后，你获得一个「凛」。你的手牌上限+X（X为「凛」的数量）。",
	dcjianghuo:"降祸",
	dcjianghuo_info:"觉醒技，回合开始时，若所有角色均受到过伤害，你将所有「凛」移动到自己的武将牌上，并摸与「凛」等量的牌，然后加一点体力上限，失去〖凛界〗，获得〖立世〗。",
	dclishi:"立世",
	dclishi_info:"锁定技，结束阶段，若你没有「凛」，你受到1点雷电伤害；若你有「凛」，你失去任意个「凛」并选择等量选项令所有其他角色执行：1.下个准备和结束阶段非锁定技失效；2.下个判定阶段在【闪电】、【乐不思蜀】和【兵粮寸断】中选择一个并进行判定，3.下个摸牌阶段摸到的牌若颜色相同，则全部弃置，4.下个出牌阶段每种类型的牌仅能使用一张，5.下个弃牌阶段弃置的牌改为被你获得。",
	hm_shen_lijueguosi: "汉末神李傕郭汜",
	hm_shen_lijueguosi_prefix: "汉末神",
	hmweijue: "威傕",
	hmweijue_info: "锁定技，准备阶段，从你的下家开始所有其他角色依次将任意张手牌置于武将牌上直到回合结束，称为“威”；若一名角色的“威”不大于其手牌数，你与其视为在彼此攻击范围内。",
	hmchuxiong: "除凶",
	hmchuxiong_info: "出牌阶段开始时，你可以展示所有手牌并弃置其中一种颜色的所有牌，若你以此法弃置的牌颜色为：黑色，你获得等量张“威”；红色，你对攻击范围内的所有其他角色依次造成1点伤害。",
	hm_shen_caocao: "汉末神曹操",
	hm_shen_caocao_prefix: "汉末神",
	hmzhaoshao: "诏绍",
	hmzhaoshao_info: "当你造成或受到1点伤害后，你可以摸一张牌，然后令受伤角色或伤害来源：1.获得弃牌堆或场上的一张装备牌并使用之（此装备占用独立装备栏）；2.翻面并摸一张牌；3.减少1点体力上限。",
	hmxiaoxiong: "嚣凶",
	hmxiaoxiong_info: "锁定技，当你翻面时，取消之，然后令所有其他角色失去1点体力。",
	hm_shen_wangyun: "汉末神王允",
	hm_shen_wangyun_prefix: "汉末神",
	hmanchao: "安朝",
	hmanchao_info: "一名角色的回合结束时，若本回合有角色使用过虚拟牌或转化牌，你可摸一张牌并获得1点蓄力值。",
	hmyurong: "御戎",
	hmyurong_info: "锁定技，你于一轮内首次成为一种伤害牌的目标时，取消之。",
	hmdingxi: "定西",
	hmdingxi_info: "蓄力技（4/∞）。当你连续使用一种类型的牌时，你可以消耗1点蓄力值并展示牌堆顶的一张牌，若类型相同，你使用之，否则你从牌堆底摸一张牌；若连续相同2/3次，你回复全部体力/对所有其他角色各造成1点伤害。",
};
