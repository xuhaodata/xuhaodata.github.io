const translates = {
	...
	spolzhubei: "逐北",
	spolzhubei_info: "出牌阶段各限一次，你可以令一名其他角色将至少X张牌当作无距离和任何次数限制的【杀】或【决斗】对你使用（X为本回合所有角色本回合使用基本牌的次数+1）。当你以此法受到伤害后，你可以获得这些牌；此牌结算后，若你未以此法受到伤害，你回复1点体力，然后可以与其交换手牌。",
	...
	olsiqi: "思泣",
	olsiqi_info: "你的红色牌进入弃牌堆时，将之置于牌堆底。当你受到伤害后，你可以亮出牌堆底至多四张连续的红色牌，使用其中【桃】、【无中生有】与装备牌（可指定其他角色为目标），然后你摸剩余不可使用的牌数张牌。",
	olqiaozhi: "巧织",
	olqiaozhi_info: "出牌阶段，你可以弃置一张牌并亮出牌堆顶的两张牌，然后获得其中一张，此技能失效直到你失去以此法获得的牌。",
	ol_guozhao: "OL郭照",
	ol_guozhao_prefix: "OL",
	oljiaoyu: "椒遇",
	oljiaoyu_info: "锁定技，每轮开始时，你进行X次判定（X为你空置装备栏数），然后声明一种颜色并获得此颜色的判定牌，且本轮你的下回合结束时，你执行一个出牌阶段，此阶段其他角色不能使用与你装备区牌颜色相同的牌直到其受到伤害。",
	olneixun: "内训",
	...
	olfengwei: "奉蔚",
	olfengwei_info: "锁定技，每轮开始时，你摸一至四张牌（这些牌本轮不计入手牌上限）。若如此做，当你受到伤害时，若你有本轮获得的“奉蔚”牌，此伤害+1。",
	olzonghu: "宗护",
	olzonghu_info: "每回合限一次，当你需要使用【杀】或【闪】时，你可以将X张牌交给一名其他角色（X为游戏轮数且至多为3），视为使用之。",
	sp_ol_liubei: "SP刘备",
