const characterSort = {
	sp_tianji: ["liuyan", "caoteng", "sunhao", "liuxie", "caoang", "hetaihou", "sunluyu", "ol_wangrong", "zuofen", "ol_bianfuren", "qinghegongzhu", "tengfanglan", "ruiji", "caoxiancaohua", "caoyu", "ol_qinlang", "ol_liuzhang", "ol_guozhao"],
	sp_sibi: ["ol_yuanhuan", "liuyan", "yanjun", "panjun", "lvqian", "wangcan", "ol_lukai", "yangxiu", "guotu", "chenlin", "chengyu", "shixie", "fuwan", "wangyun", "zhugejin", "simalang", "maliang", "buzhi", "dongyun", "kanze", "sunqian", "xizhicai", "sunshao", "duxi", "jianggan", "ol_dengzhi", "ol_yangyi", "ol_dongzhao", "ol_chendeng", "jin_yanghu", "wangyan", "xiahouxuan", "quhuang", "zhanghua", "wangguan", "sunhong", "caoxi", "tianchou", "ol_peixiu", "ol_hanfu", "ol_taoqian"],
	sp_tianzhu: ["ol_yangfeng", "ol_liupi", "budugen", "ol_kebineng", "yadan", "liyi", "zhangyan", "niujin", "hejin", "hansui", "wutugu", "yanbaihu", "shamoke", "zhugedan", "huangzu", "gaogan", "tadun", "fanjiangzhangda", "ahuinan", "dongtuna", "ol_wenqin", "mawan", "ol_niufu", "ol_wujing"],
	...
	sp_waitforsort: ["ol_tw_zhangji", "ol_peiyuanshao"],
};
