const translates = {
	...
	dcwujie: "无节",
	dcwujie_info: "锁定技。①你使用无色牌无距离限制且不计入使用次数。②当其他角色执行杀死你的奖惩而摸牌或弃牌时，取消之。",
	...
	starwenming: "威名",
	starwenming_info: "锁定技，体力值小于你或本轮受到过你造成伤害的其他角色对你使用牌时，其随机弃置一张手牌，若所有条件同时满足，则你摸一张牌。",
	star_zhangrang: "星张让",
	...
	starlingse: "令色",
	starlingse_info: "出牌阶段限一次，你可交给一名其他角色1张牌，然后随机获得该角色与此牌类型相同的2张牌，不足两张则视为其对你使用1张【杀】 。若此【杀】造成伤害，则视为此技能未发动过。",
};
