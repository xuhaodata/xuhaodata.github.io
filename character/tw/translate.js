const translates = {
	...
	twyimou: "毅谋",
	twyimou_info: "当与你距离1以内的一名角色受到伤害后，你可以选择一项：1.令其从牌堆中获得一张【杀】；2.令其将一张手牌交给另一名角色并摸两张牌；3.背水：将所有手牌交给其（若受伤角色为你则跳过此步骤），然后依次执行上述所有选项。",
	tw_liufuren: "刘夫人",
	twzhuidu: "追妒",
	...
	twliyuan: "离渊",
	twliyuan_info: "你可将一张与你已废除的装备栏对应副类别的装备牌当【杀】使用或打出（无距离和次数限制），然后你摸一张牌。",
	twjifa: "冀筏",
