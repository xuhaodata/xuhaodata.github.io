const translates = {
	...
	twchenxun: "沉勋",
	twchenxun_info: "一轮游戏开始时，你可以视为对一名其他角色使用一张【决斗】。此牌结算结束后，若此牌对其造成过伤害，你摸一张牌且可以对一名本轮未以此法选择的其他角色发动〖沉勋〗；否则你失去1点体力。",
	huan_caoang: "幻曹昂",
	...
	twkanpo: "看破",
	twkanpo_info: "①一轮游戏开始时，你清除〖看破①〗记录的牌名，然后你可以依次记录任意个未于上次发动〖看破①〗记录清除过的非装备牌牌名（对其他角色不可见，每局游戏至多记录3个牌名）。②其他角色使用你〖看破①〗记录过的牌名的牌时，你可以移去一个〖看破①〗中的此牌名的记录令此牌无效，然后你摸一张牌。",
	tw_sb_caopi: "TW谋曹丕",
