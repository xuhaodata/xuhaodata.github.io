const translates = {
	...
	dddfengzheng: "丰政",
	dddfengzheng_info: "①每名角色的出牌阶段限一次。其可将点数之和为13的任意张手牌当一张【无中生有】使用。②每轮开始时，你可观看并分配牌堆顶的X张牌（X为上一轮发动过〖丰政〗的角色数），若有角色以此法得到的牌数多于两张，你失去〖丰政〗。",
	dddyulv: "玉律",
	...
	dddyouxue: "游学",
	dddyouxue_info: "锁定技。每轮开始时，你将场上的“游学”标记交给一名其他角色（若场上没有“游学”，你获得“游学”），然后摸X张牌（X为本次失去“游学”的角色至获得“游学”的角色的距离）。",
	dddchengjing: "承经",
	...
	dddmoyan: "末焱",
	dddmoyan_info: "每轮开始时，你可以亮出牌堆顶三张牌，令一名角色选择获得其中至少一张牌，然后当你于本轮受到伤害时，若其手牌数不大于X，此伤害+1（X为其本次获得的牌数）。",
	ddd_luoxian: "罗宪",
	dddshilie: "示烈",
	visible_dddshilie: "明",
