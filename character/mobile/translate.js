...
const translates = {
	...
	pot_yuji_prefix: "势",
	potdaozhuan: "道转",
	potdaozhuan_info: "每回合限一次，你可以将你或者当前回合角色的一张牌置入弃牌堆，视为使用一张基本牌（每轮每种牌名限一次）。若当前回合角色因此失去了张牌，则本轮此技能失效。",
	potfuji: "符济",
	potfuji_info: "出牌阶段限一次，你可以展示至多X张手牌并交给等量角色，称为“符济”（X为场上其他角色数）。这些角色使用“符济”牌时获得一张与“符济”牌花色相同的牌；这些角色使用“符济”【杀】造成的伤害+1；这些角色使用“符济”【闪】结算完毕后摸一张牌。然后若你的手牌数为全场最低，则你摸一张牌，且你使用的下一张【杀】和【闪】视为拥有对应效果直到你的下个回合开始。",
	friend_cuijun: "友崔均",
