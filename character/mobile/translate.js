...
const translates = {
	...
	mbyuanmo: "远谟",
	mbyuanmo_info: "每回合限两次，准备阶段或当你受到伤害后，你可以移动场上的一张牌，然后你可以令因此失去牌的角色摸X张牌（X为其攻击范围内因此减少的角色数）",
	wuke: "吴珂",
	mbzhuguo: "助国",
	...
	mbxuehen: "雪恨",
	mbxuehen_info: "1级：当你每回合首次造成或受到伤害后，你可展示至多X张手牌（X为你已损失体力值），这些牌只能当不计入次数且无次数限制的【杀】使用或打出，直到你使用这些牌造成伤害。<br>2级：当你每回合首次造成或受到伤害后，你可展示至多X张手牌（X为你已损失体力值），这些牌只能当不计入次数且无次数限制的【杀】使用或打出，直到你使用这些牌造成伤害，且使用以此法转化的【杀】结算结束后摸一张牌。",
	mbhuxiao: "虎啸",
