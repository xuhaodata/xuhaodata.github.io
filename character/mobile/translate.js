...
const translates = {
	...
	mbjiexun: "诫训",
	mbjiexun_info: "结束阶段，你可以选择一种花色，令一名其他角色摸等同于场上此花色数量的牌（至多为5），然后其弃置x张牌（x为本技能发动的次数）。若其因此弃置所有手牌，你升级〖复难〗。",
	pot_dongzhao: "势董昭",
	...
	mbzengou: "谮构",
	mbzengou_info: "出牌阶段限一次，你可以观看一名角色的手牌，然后你选择一项：①视为使用其手牌中未拥有的基本牌牌名的一张牌（无距离和次数限制）；②将你与其手牌中共同牌名的牌替换为牌堆中等量的【杀】，这些【杀】不计入手牌上限直到各自的结束阶段。然后你选择一个基本牌牌名，令其获得1枚此牌名对应的“诬”标记（每回合使用第一张牌结算完毕后，若拥有此牌名的“诬”标记，则失去1点体力并移去1枚此牌名的“诬”标记）。",
	mbfeili: "诽离",
	...
	potjiyu: "急御",
	potjiyu_info: "①出牌阶段限一次，你可以弃置一张手牌，从牌堆中随机获得与此牌类别不同的牌各一张。②每阶段限一次，当你失去本阶段因〖急御①〗获得的所有牌后，你重置〖急御①〗。",
	pot_yuji: "势于吉",
	pot_yuji_prefix: "势",
	potdaozhuan: "道转",
	...
	mbxiezheng: "挟征",
	mbxiezheng_info: "结束阶段，你可以令一名角色依次将一张手牌置于牌堆顶，然后你视为使用一张【兵临城下】。然后若此牌若未造成伤害，你失去1点体力。",
	mbxiezheng_info_identity: "结束阶段，你可以令一名角色依次将一张手牌置于牌堆顶，然后你视为使用一张【兵临城下】（若你未发动〖昭凶〗，则此牌须优先指定同势力角色）。然后若此牌未造成伤害，你失去1点体力。",
	mbxiezheng_info_doudizhu: "每局游戏限一次。结束阶段，你可以令至多两名角色依次将一张手牌置于牌堆顶，然后你视为使用一张【兵临城下】。然后若此牌未造成伤害，你失去1点体力。",
	mbzhaoxiong: "昭凶",
	mbzhaoxiong_info: "限定技，准备阶段，若你已受伤，你可以变更势力为群，获得技能〖荡异〗。",
	mbweisi: "威肆",
	...
	mbdangyi: "荡异",
	mbdangyi_info: "主公技，每回合限一次，每局游戏限两次。当你造成伤害时，你可以令此伤害+1。",
};
