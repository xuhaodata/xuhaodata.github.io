...
const translates = {
	...
	baoxin: "鲍信",
	mutao: "募讨",
	mutao_info: "出牌阶段限一次。你可以选择一名角色，令其将手牌中所有的【杀】置于武将牌上，然后将这些牌依次随机交给其下家开始的每一名其他角色。然后其对最后一名以此法获得【杀】的角色A造成X点伤害（X为A手牌中【杀】的数量且至多为2）。",
	yimou: "毅谋",
	...
	mbzuoyou_info_versus_two: "转换技。出牌阶段限一次，阴：你可以令一名角色摸三张牌，然后其弃置两张手牌；阳：你可以令一名角色获得1点护甲。",
	mbshishou: "侍守",
	...
	mbzengou: "谮构",
	mbzengou_info: "出牌阶段限一次，你可以观看一名角色的手牌，然后你选择一项：①视为使用两张其手牌中未拥有的基本牌牌名的牌（无距离和次数限制）；②将你与其手牌中共同牌名的牌替换为牌堆中等量的【杀】，这些【杀】不计入手牌上限直到各自的结束阶段。然后你选择一个基本牌牌名，令其获得1枚此牌名对应的“诬”标记（每回合使用第一张牌结算完毕后，若拥有此牌名的“诬”标记，则失去1点体力并移去1枚此牌名的“诬”标记）。",
	mbfeili: "诽离",
	...
	potfuji: "符济",
	potfuji_info: "出牌阶段限一次，你可以展示至多X张手牌并交给等量其他角色，称为“符济”（X为场上其他角色数）。其他角色使用“符济”牌时获得一张与“符济”牌花色相同的牌；然后若此牌为：【杀】，此牌造成的伤害+1；【闪】，结算完毕后其摸一张牌。然后若你的手牌数为全场最低，则你摸一张牌，且你使用的下一张【杀】和【闪】视为拥有对应效果直到你的下个回合开始。",
	friend_cuijun: "友崔均",
	...
	pangxi: "庞羲",
	mbxuye: "蓄业",
	mbxuye_info: "当全场手牌数最少的角色受到伤害后，你可以令其摸两张牌，然后若其手牌数因此成为全场最多，你将其场上的一张牌置于牌堆顶。",
	mbkuangxiang: "匡襄",
	mbkuangxiang_info: "出牌阶段限一次，你可以与一名手牌数少于你的其他角色交换手牌，且直到你的下个出牌阶段开始前，你或其失去所有因此获得的手牌后，你可以执行一次〖蓄业〗的效果（不受发动次数影响）。",
	sunsháo: "孙韶",
	mbganjue: "敢决",
	...
	pothongyi: "弘毅",
	pothongyi_info: "锁定技。①游戏开始时，你获得2个「毅」标记；当你造成或受到1点伤害后，你获得1个「毅」标记；你至多拥有4个「毅」标记。②准备阶段，你选择一项，并于结束阶段执行另一项：1.摸X张牌（X为你拥有的「毅」标记数）；2.移去所有「毅」标记",
	...
	mbhuxiao: "虎啸",
	mbhuxiao_info: "出牌阶段限一次，你可选择一项：1.对一名体力值大于等于你的角色造成1点火焰伤害：2.本回合使用牌无距离限制；3.背水：弃置一张红色牌。",
	mbwuji: "武继",
	mbwuji_info: "限定技，出牌阶段，你可修改〖雪恨〗直到本阶段结束。此阶段结束时，若你因〖雪恨〗获得大于等于两张牌，你改为永久修改〖雪恨〗。",
	mb_luyusheng: "手杀陆郁生",
	mb_luyusheng_prefix: "手杀",
	mbrunwei: "润微",
	mbrunwei_info: "出牌阶段限一次，你可以展示牌堆顶至多三张牌，令一名角色获得其中一种颜色的所有牌。若如此做，本阶段你再失去X张牌后（X为其因此获得的牌数），该技能视为未发动过但不能以本回合获得过牌的角色为目标。若获得牌的角色为你，本阶段结束时，你弃置以此法获得的牌。",
	mbshuanghuai: "霜怀",
	mbshuanghuai_info: "每回合限一次，当与你距离1以内的角色受到伤害时，你可以选择一项：1.防止此伤害；2.令其从弃牌堆中获得一张【桃】。若该角色与你上一次发动时不同，你失去1点体力。",
	mb_tianfeng: "手杀田丰",
	mb_tianfeng_prefix: "手杀",
	mbganggeng: "刚鲠",
	mbganggeng_info: "出牌阶段限一次，你可以将至少两张手牌交给一名其他角色。回合结束时，若其手牌数：为全场最多，你摸一张牌；不为全场最多，你弃置其区域里的一张牌。",
	mbsijian: "死谏",
	mbsijian_info: "每回合限两次，当你失去最后的手牌后，或当你进入濒死状态时，你可以选择一项：1.选择一名其他角色，其使用下一张牌后需弃置一张牌。2.令当前回合角色摸两张牌。若此时没有角色处于濒死状态，你可以背水：失去X点体力（X为你此前发动过背水的次数）。",
	mb_huangzu: "手杀黄祖",
	mb_huangzu_prefix: "手杀",
	mbchizhang: "鸱张",
	mbchizhang_info: "你使用伤害牌无距离限制。当你使用手牌中除闪电外的伤害牌指定目标后，你可以弃置任意数量的手牌，其他角色不能使用与你此法弃置牌花色相同的牌响应此牌。",
	mbduanyang: "断鞅",
	mbduanyang_info: "每回合限一次，当你不因使用而失去手牌后，你可以将其中随机一张【杀】置于武将牌上，并于本阶段结束时对一名角色使用之；当你使用【杀】造成伤害后，你可以重铸受伤角色区域内至多两张牌，然后你获得重铸牌中的基本牌，或摸等量张牌。",
	guoyuan: "国渊",
	mbqingdao: "清蹈",
	...
	mbjinzu: "劲镞",
	mbjinzu_info: "①出牌阶段限一次，你可以选择一名其他角色，与其分别同时展示一/两张手牌，若你的展示牌点数在所有牌中：为最值，你弃置所有展示牌；不为最值，你本回合使用的下一张【杀】对其造成伤害+1且其不可响应。②每阶段限一次，你因此技能失去牌后，重置〖劲镞〗①。",
	mbanxian: "暗弦",
