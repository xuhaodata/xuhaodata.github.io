const translates = {
	...
	wuhujiang_prefix: "魂",
	olhuyi: "虎翼",
	olhuyi_info: "①游戏开始时，你从随机三个五虎将技能中选择一个获得。②当你使用或打出一张基本牌后，若你因此技能获得的技能数小于5，你随机获得一个技能描述中包含此牌名的五虎将技能。③回合结束时，你可以失去一个以此法获得的技能，然后你可以观看一名其他角色的随机三张手牌并获得其中一张。",
	liuxiecaojie: "刘协曹节",
	dcjuanlv: "眷侣",
	...
	get olsuichong_info() {
		...
		return "①游戏开始时，你可以发起一次“拼手气”红包；②每局游戏限三次，准备阶段，你可以" + (cost ? "消耗10金币并" : "") + "发起一次“拼手气”红包。运气最好的角色从三个生效兽技能中选择一个令你获得（覆盖之前你以此法获得的生效兽技能）。";
	},
	olshouhun: "兽魂",
	...
	olyinfeng: "引锋",
	olyinfeng_info: "锁定技。①游戏开始时，你获得一张【赤血青锋】。②当【赤血青锋】因弃置进入牌堆后，你失去1点体力并获得之。③当你的手牌被其他角色获得后，若你的手牌中有【赤血青锋】，你对其造成1点伤害；若其本次获得的牌中有【赤血青锋】，其对你造成1点伤害。",
	olfulu: "负掳",
