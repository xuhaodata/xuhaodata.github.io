const translates = {
	...
	oltiangong: "天公",
	oltiangong_info: "锁定技，回合开始时，你视为使用一张【雷公助我】；回合结束时，你视为使用一张【有难同当】。一名角色判定后，若为黑桃，你对另一名角色造成1点伤害。",
	oldigong: "地公",
	oldigong_info: "锁定技，你使用不为你本轮获得的牌时，若为伤害牌，此牌伤害+1，若不为伤害牌，结算后当前回合角色判定，若为红色，你摸一张牌。",
	olrengong: "人公",
